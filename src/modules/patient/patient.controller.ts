...
export class PatientsController {
  ...
  @ApiResponse({
    status: 403,
    description: 'Authenticated user does not have the PATIENT role.',
  })
  @ApiResponse({
    status: 409,
    description: 'A patient profile already exists for this user.',
  })
  async createProfile(
  ...
  @ApiOperation({
    ...
    description:
      'Returns the patient profile belonging to the currently authenticated user.',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiResponse({
    status: 404,
    description: 'No patient profile exists for this user yet.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Returns the medical/health record history associated with the authenticated patient.',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Returns the full consultation booking history for the authenticated patient.',
  })
  @ApiResponse({
    status: 200,
